#
#  Be sure to run `pod spec lint IGCStatefulView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/Jason Jon E. Carreos"
  ...
  s.source       = { :git => "https://github.com/jason-ingenuity/IGCStatefulView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "IGCStatefulView", "IGCStatefulView/**/*.{h,m,swift}"
  ...
  # s.resource  = "icon.png"
  s.resources = "IGCStatefulView/*.xib"
